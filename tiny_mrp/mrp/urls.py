...
urlpatterns = [
    ...
    url(r'^Tolid/Daily/Export$',export_daily_amar_tolid,name='export_daily_amar_tolid'),
    ...
    url(r'^Monthly2/$', monthly_detaild_report2, name='monthly_detaild_report2'),
    url(r'^Monthly/Export$', monthly_detaild_export, name='monthly_detaild_export'),
    url(r'^Monthly/Export2$', monthly_detaild_export2, name='monthly_detaild_export2'),
    url(r'^Monthly/Brief$', monthly_brief_report, name='monthly_brief_report'),
    url(r'^Monthly/Brief/Export$', monthly_brief_export, name='monthly_brief_export'),
