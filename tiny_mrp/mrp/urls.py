...
urlpatterns = [
    ...
    url(r'^Tolid/DailyDetails/Scroll$',get_daily_amar_scroll,name='get_daily_amar_scroll'),
    ...
    url(r'^Tolid/Calendar/Scroll$',calendar_main_scroll,name='calendar_main_scroll'),
    ...
    url(r'^Report/Main_Main/$', daily_tolid_main_main, name='daily_tolid_main_main'),
    ...
    url(r'^Purchases/UpdateNotes/(?P<comment_id>\d+)/$', update_note, name='update_note'),
