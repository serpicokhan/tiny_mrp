...
urlpatterns = [
    ...
    url(r'^Asset/Randeman/V2/NezafatRanking/Create$', assetRandeman_ranking_create_v2, name='assetRandeman_ranking_create_v2'),
    ...
    url(r'^Asset/Randeman/V2/NezafatRanking/calc_assetRandeman_nezafat_ranking$', calc_assetRandeman_nezafat_ranking_v2, name='calc_assetRandeman_nezafat_ranking_v2'),
    ...
    url(r'^Asset/Randeman/V2/NezafatPadash/$', list_nezafat_padash_v2, name='list_nezafat_padash_v2'),
    ...
    url(r'^Asset/Randeman/V2/NezafatPadash/(?P<id>\d+)/update$', nezafatPadash_update_v2, name='nezafatPadash_update_v2'),
    ...
    url(r'^Report/V2/$', daily_tolid_with_chart2, name='daily_tolid_with_chart2'),
