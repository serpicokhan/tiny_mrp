...
$(document).ready(function () {
      ...
      var config = {
        ...
        data: {
          datasets: [
            {
              borderWidth: 3,
              borderColor: $("body").hasClass("dark")
                ? "#313852"
                : "rgba(255, 255, 255, 1)",
              data: [1242, 742, 442, 1742],
              backgroundColor: [
                colors.danger,
                colors.info,
                colors.warning,
          ...
          labels: ["Organic Search", "Email", "Refferal", "Social Media"],
        },
        options: {
          responsive: true,
          legend: {
  ...
  function contactsStatuses() {
    if ($("#contacts-statuses").length) {
      var chart = new ApexCharts(document.querySelector("#contacts-statuses"), {
        chart: {
          width: "100%",
          type: "donut",
        },
  ...
  function hotProducts() {
    if ($("#hot-products").length) {
      ...
      window.onload = function () {
        ...
        document.getElementById("hot-products-legends").innerHTML =
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      labels: [
        "سامسونگ گلکسی نوت 9 9 6/128GB",
        " سامسونگ گلکسی آ 30 3/32 GB آبی",
        "ایسوس راگ 8/128GB آبی",
        "اپل آیفون ایکس آر 256 GB قرمز",
        "اپل آیفون ایکس آر 24 GB قرمز",
      ],
